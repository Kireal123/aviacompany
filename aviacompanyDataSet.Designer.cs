...
SELECT ID, RoleID, Email, Password, FirstName, LastName, OfficeID, Birthdate, Active FROM Users WHERE (ID = @ID)";
        ...
        public virtual int Fill(aviacompanyDataSet.UsersDataTable dataTable) {
        ...
        public virtual aviacompanyDataSet.UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            aviacompanyDataSet.UsersDataTable dataTable = new aviacompanyDataSet.UsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(aviacompanyDataSet.UsersDataTable dataTable) {
